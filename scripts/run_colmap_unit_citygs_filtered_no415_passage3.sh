...
CONFIG="${CONFIG:-scene_W2_4_3_merged_rooms_passage_v3_no405410416_filtered_no415_passage3_units}"
...
PARTITION_NAME="${PARTITION_NAME:-scene_W2_4_3_merged_rooms_passage_v3_no405410416_filtered_no415_passage3_units}"
