...
SETUP_SCRIPT="${SETUP_SCRIPT:-$ROOT_DIR/scripts/setup_current_server_experiments.sh}"
...
DATA_ROOT_REL="${DATA_ROOT_REL:-data/matrix_city/aerial_subset}"
DATA_ROOT="$ROOT_DIR/$DATA_ROOT_REL"
TRAIN_SOURCE="${TRAIN_SOURCE:-$DATA_ROOT/train/block_all}"
CUSTOM_TEST="${CUSTOM_TEST:-$DATA_ROOT/test/block_all_test}"
VIEW_MANIFEST="${VIEW_MANIFEST:-$ROOT_DIR/output/boundary_analysis/subset4_block_all_test_strict_current_server.json}"
MAX_CACHE_NUM="${MAX_CACHE_NUM:-64}"
...
if [[ ! -f "$RUNTIME_CFG_DIR/mc_small_aerial_subset_c4_smoke.yaml" ]] || [[ ! -d "$DATA_ROOT/train/block_all" ]]; then
  run_step "current-server setup" bash "$SETUP_SCRIPT"
fi

# --- 5k iteration experiments ---
run_coarse "$RUNTIME_CFG_DIR/mc_small_aerial_subset_coarse_5k.yaml" output/mc_small_aerial_subset_coarse_5k 5000
run_non_overlap "$RUNTIME_CFG_DIR/mc_small_aerial_subset_c4_5k.yaml" output/mc_small_aerial_subset_c4_5k 5000 mc_small_aerial_subset_c4_5k
run_overlap "$RUNTIME_CFG_DIR/g1_overlap15_subset_5k.yaml" output/g1_overlap15_subset_5k 5000 g1_overlap15_subset_5k
run_overlap "$RUNTIME_CFG_DIR/g2_overlap25_subset_5k.yaml" output/g2_overlap25_subset_5k 5000 g2_overlap25_subset_5k

# --- 10k iteration experiments ---
run_coarse "$RUNTIME_CFG_DIR/mc_small_aerial_subset_coarse_10k.yaml" output/mc_small_aerial_subset_coarse_10k 10000
run_non_overlap "$RUNTIME_CFG_DIR/mc_small_aerial_subset_c4_10k.yaml" output/mc_small_aerial_subset_c4_10k 10000 mc_small_aerial_subset_c4_10k
run_overlap "$RUNTIME_CFG_DIR/g1_overlap15_subset_10k.yaml" output/g1_overlap15_subset_10k 10000 g1_overlap15_subset_10k
run_overlap "$RUNTIME_CFG_DIR/g2_overlap25_subset_10k.yaml" output/g2_overlap25_subset_10k 10000 g2_overlap25_subset_10k
