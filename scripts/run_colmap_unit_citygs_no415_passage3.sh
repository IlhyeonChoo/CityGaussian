...
CONFIG="${CONFIG:-scene_W2_4_3_merged_rooms_passage_v3_no405410416_no415_passage3_units}"
SOURCE_PATH="${SOURCE_PATH:-data/W2_4_3_merge_rooms_with_passage_v3_undistorted/combined_no_405_410_416}"
PARTITION_NAME="${PARTITION_NAME:-scene_W2_4_3_merged_rooms_passage_v3_no405410416_no415_passage3_units}"
