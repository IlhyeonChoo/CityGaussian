# Legacy Local Setup Notes

> Legacy note: this file preserves the temporary 16GB server setup state from
> the earlier pilot phase. Use the root `LOCAL_SETUP_NOTES.md` for the active
